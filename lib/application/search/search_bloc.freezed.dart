...
class _$_SearchState implements _SearchState {
  ...
  @override
  String toString() {
    return 'SearchState(isLoading: $isLoading, isError: $isError, idleList: $idleList, searchResultList: $searchResultList)';
  }
...
abstract class _SearchState implements SearchState {
  const factory _SearchState(
      ...
      required final List<Downloads> idleList,
      required final List<SearchResultData> searchResultList}) = _$_SearchState;
